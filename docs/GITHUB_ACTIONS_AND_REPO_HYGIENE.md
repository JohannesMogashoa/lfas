...
Never commit real bank statements or sensitive financial data. The `.gitignore` intentionally blocks common local paths and file patterns for uploaded statements and private samples.
