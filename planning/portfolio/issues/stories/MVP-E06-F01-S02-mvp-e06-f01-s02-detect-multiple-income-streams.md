# Story: Detect multiple income streams
...
As a product builder of LFAS, I want `Detect multiple income streams` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Income streams grouped
