# Story: Create cashflow forecast model
...
As a product builder of LFAS, I want `Create cashflow forecast model` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Forecast output model exists
