# Story: Track statement processing usage

## Parent

- Epic: V1-E02 — Multi-Tenancy
- Feature: V1-E02-F02 — Usage Tracking
...
As a product builder of LFAS, I want `Track statement processing usage` so that the system can progress toward trusted, private financial analysis.
