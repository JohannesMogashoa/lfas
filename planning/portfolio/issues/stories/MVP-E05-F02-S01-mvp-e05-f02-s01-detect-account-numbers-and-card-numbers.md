# Story: Detect account numbers and card numbers
...
As a product builder of LFAS, I want `Detect account numbers and card numbers` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Sensitive numbers detected
