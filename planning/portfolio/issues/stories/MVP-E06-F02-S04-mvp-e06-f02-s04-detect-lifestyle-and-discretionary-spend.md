# Story: Detect lifestyle and discretionary spend
...
As a product builder of LFAS, I want `Detect lifestyle and discretionary spend` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Discretionary spend calculated
