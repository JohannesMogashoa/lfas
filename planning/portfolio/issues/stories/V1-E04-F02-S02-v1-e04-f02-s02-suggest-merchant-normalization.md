# Story: Suggest merchant normalization
...
As a product builder of LFAS, I want `Suggest merchant normalization` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Unknown merchants enriched
