# Story: Create sync audit events
...
As a product builder of LFAS, I want `Create sync audit events` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Sync activity auditable
