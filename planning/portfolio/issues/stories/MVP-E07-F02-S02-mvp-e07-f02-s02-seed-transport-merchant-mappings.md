# Story: Seed transport merchant mappings
...
As a product builder of LFAS, I want `Seed transport merchant mappings` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Transport merchants mapped
