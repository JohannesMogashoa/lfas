# Story: Create category taxonomy
...
As a product builder of LFAS, I want `Create category taxonomy` so that the system can progress toward trusted, private financial analysis.
