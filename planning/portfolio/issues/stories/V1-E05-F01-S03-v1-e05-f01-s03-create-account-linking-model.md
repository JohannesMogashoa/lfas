# Story: Create account linking model
...
As a product builder of LFAS, I want `Create account linking model` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] External accounts represented safely
