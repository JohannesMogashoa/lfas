# Story: Estimate emergency fund and cash buffer
...
As a product builder of LFAS, I want `Estimate emergency fund and cash buffer` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Buffer estimate produced
