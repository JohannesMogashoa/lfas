# Story: Create Standard Bank transaction parser
...
As a product builder of LFAS, I want `Create Standard Bank transaction parser` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Standard Bank fixture extracted
