# Story: Create budget recommendations
...
As a product builder of LFAS, I want `Create budget recommendations` so that the system can progress toward trusted, private financial analysis.
