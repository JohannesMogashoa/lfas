# Story: Create OCR image preprocessing pipeline
...
As a product builder of LFAS, I want `Create OCR image preprocessing pipeline` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] OCR quality improves on test fixture
