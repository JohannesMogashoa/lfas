# Story: Create questionnaire domain model
...
As a product builder of LFAS, I want `Create questionnaire domain model` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Versioned questionnaire model exists
