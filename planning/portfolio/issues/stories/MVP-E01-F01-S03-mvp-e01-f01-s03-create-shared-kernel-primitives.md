# Story: Create financial domain primitives package
...
As a product builder of LFAS, I want `Create financial domain primitives package` so that the system can progress toward trusted, private financial analysis.
