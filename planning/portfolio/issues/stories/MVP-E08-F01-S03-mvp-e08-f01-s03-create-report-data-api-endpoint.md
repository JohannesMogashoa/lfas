# Story: Create report data API endpoint
...
As a product builder of LFAS, I want `Create report data API endpoint` so that the system can progress toward trusted, private financial analysis.
