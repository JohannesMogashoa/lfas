# Story: Create Nedbank transaction parser
...
As a product builder of LFAS, I want `Create Nedbank transaction parser` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Nedbank fixture extracted
