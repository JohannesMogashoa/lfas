# Story: Create Excel export using ClosedXML
...
As a product builder of LFAS, I want `Create Excel export using ClosedXML` so that the system can progress toward trusted, private financial analysis.
