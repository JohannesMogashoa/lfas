# Story: Create Excel export using a Node workbook library
...
As a product builder of LFAS, I want `Create Excel export using a Node workbook library` so that the system can progress toward trusted, private financial analysis.
