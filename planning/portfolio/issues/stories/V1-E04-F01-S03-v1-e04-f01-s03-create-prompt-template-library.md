# Story: Create prompt template library
...
As a product builder of LFAS, I want `Create prompt template library` so that the system can progress toward trusted, private financial analysis.
