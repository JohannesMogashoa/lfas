# Story: Create risk recommendations
...
As a product builder of LFAS, I want `Create risk recommendations` so that the system can progress toward trusted, private financial analysis.
