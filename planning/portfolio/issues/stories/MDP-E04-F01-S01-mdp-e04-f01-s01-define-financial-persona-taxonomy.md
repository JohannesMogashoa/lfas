# Story: Define financial persona taxonomy
...
As a product builder of LFAS, I want `Define financial persona taxonomy` so that the system can progress toward trusted, private financial analysis.
