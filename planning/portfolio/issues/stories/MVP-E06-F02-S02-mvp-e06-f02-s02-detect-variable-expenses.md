# Story: Detect variable expenses
...
As a product builder of LFAS, I want `Detect variable expenses` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Variable expense metrics produced
