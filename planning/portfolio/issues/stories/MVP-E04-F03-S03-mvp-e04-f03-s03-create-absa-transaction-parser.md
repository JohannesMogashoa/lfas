# Story: Create ABSA transaction parser
...
As a product builder of LFAS, I want `Create ABSA transaction parser` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] ABSA fixture extracted
