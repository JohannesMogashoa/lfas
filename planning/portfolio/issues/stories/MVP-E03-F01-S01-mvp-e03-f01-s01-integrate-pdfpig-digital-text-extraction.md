# Story: Integrate Node PDF text extraction
...
As a product builder of LFAS, I want `Integrate Node PDF text extraction` so that the system can progress toward trusted, private financial analysis.
