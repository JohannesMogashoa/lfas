# Story: Create debt recommendations
...
As a product builder of LFAS, I want `Create debt recommendations` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Debt recommendations generated

## Implementation Tasks

- [ ] High DTI
- [ ] Debt snowball/avalanche hints
