# Story: Create subscription plan model
...
As a product builder of LFAS, I want `Create subscription plan model` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Plans represented in domain
