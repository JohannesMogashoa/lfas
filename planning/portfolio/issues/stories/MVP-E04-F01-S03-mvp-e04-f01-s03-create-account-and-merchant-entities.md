# Story: Create Account and Merchant entities
...
As a product builder of LFAS, I want `Create Account and Merchant entities` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] No raw account numbers required

## Implementation Tasks

- [ ] Account surrogate id
