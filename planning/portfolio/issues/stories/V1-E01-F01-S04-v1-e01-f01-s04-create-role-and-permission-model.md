# Story: Create role and permission model
...
As a product builder of LFAS, I want `Create role and permission model` so that the system can progress toward trusted, private financial analysis.
