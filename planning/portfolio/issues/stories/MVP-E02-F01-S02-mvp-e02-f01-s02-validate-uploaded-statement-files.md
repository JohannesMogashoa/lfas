# Story: Validate uploaded statement files
...
As a product builder of LFAS, I want `Validate uploaded statement files` so that the system can progress toward trusted, private financial analysis.
...
- [ ] PDF magic bytes
- [ ] Reject encrypted PDFs with clear reason
