# Story: Calculate income stability score

## Parent

- Epic: MVP-E06 — Financial Engine
- Feature: MVP-E06-F01 — Income Analysis
...
As a product builder of LFAS, I want `Calculate income stability score` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Score produced with explanation

## Implementation Tasks

- [ ] Frequency
- [ ] Variance
- [ ] Missed income periods
