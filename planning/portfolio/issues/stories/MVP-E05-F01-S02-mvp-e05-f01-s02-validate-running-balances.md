# Story: Validate running balances
...
As a product builder of LFAS, I want `Validate running balances` so that the system can progress toward trusted, private financial analysis.
