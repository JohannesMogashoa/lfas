# Story: Create invoice metadata model

## Parent

- Epic: V1-E03 — Billing and Commercial Features
- Feature: V1-E03-F02 — Billing Integration Skeleton
...
As a product builder of LFAS, I want `Create invoice metadata model` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria

- [ ] Billing events persistable
