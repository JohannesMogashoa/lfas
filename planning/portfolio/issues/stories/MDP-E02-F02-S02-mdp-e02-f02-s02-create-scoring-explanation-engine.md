# Story: Create scoring explanation engine
...
As a product builder of LFAS, I want `Create scoring explanation engine` so that the system can progress toward trusted, private financial analysis.
