...
Support secure user access, roles, organizations, and commercial readiness.
...
- Anchor this epic in `apps/web` authentication, session, middleware, and authorization boundaries.
...
release:v1, type:epic, area:identity, priority:medium
