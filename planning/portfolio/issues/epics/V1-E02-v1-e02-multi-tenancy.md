...
Isolate data and configuration per tenant for SaaS operation.
...
- Anchor this epic in privacy/storage workspace packages and boundary code in `apps/web`.
...
release:v1, type:epic, area:security, priority:medium
