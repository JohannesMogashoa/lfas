...
Capture financial context through a versioned and conditional assessment questionnaire.
...
- Anchor this epic in future `packages/questionnaire` plus `apps/web` capture workflows.
...
release:mdp, type:epic, area:questionnaire, priority:medium
