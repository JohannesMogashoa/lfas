# Story: Create Statement aggregate
...
## User Story
As a product builder of LFAS, I want `Create Statement aggregate` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria
- [ ] Statement aggregate exists in Domain
