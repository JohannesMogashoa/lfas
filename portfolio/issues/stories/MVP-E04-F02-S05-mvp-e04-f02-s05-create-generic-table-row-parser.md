# Story: Create generic table row parser
...
## User Story
As a product builder of LFAS, I want `Create generic table row parser` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria
- [ ] Generic parser handles unknown statements
