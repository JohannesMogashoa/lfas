# Story: Create question definition loader
...
## User Story
As a product builder of LFAS, I want `Create question definition loader` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria
- [ ] Questions can be loaded from config
