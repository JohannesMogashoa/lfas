...
## User Story
As a product builder of LFAS, I want `Calculate income trends` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria
- [ ] Trend metrics produced
