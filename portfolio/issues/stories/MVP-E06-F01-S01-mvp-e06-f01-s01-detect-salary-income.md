...
## User Story
As a product builder of LFAS, I want `Detect salary income` so that the system can progress toward trusted, private financial analysis.

## Acceptance Criteria
- [ ] Likely salary identified
